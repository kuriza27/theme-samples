<?php
/**
 * Template Name: Archive Invesment
...
<div class="display-grid-view">
    <section id="<?php echo esc_attr( $id ); ?>-archive-investment" class="page-header-block pt-140 header archive-investment">
    ...
    <div class="page-content">
            <section class="archive-investment post-type-section overflow-hidden">
                <div class="container">
                        ...
                        <div class="col">
                            <div class="post-type-left">
                                <div class="post-type-results-info alt">
                                    ...
                                    <span>Your search has returned <strong><?php echo $totalpost;?> results</strong></span>
                                </div>
                                    ...
                                    <div class="col-12 col-md-6 col-lg-4 col-xl-3 post d-flex">
                                                ...
                                                <div class="flex-grow-1 d-flex flex-column post-data">
                                                            ...
                                                            <div class="post-meta"><?php $post_date = get_the_date( 'M d, Y' ); echo $post_date; ?></div>
                                                                ...
                                                                <a href="<?php echo get_permalink();?>" class="more-link mt-auto">View opportunity</a>
                                                            </div>
                                                </div>
                                    </div>
                                    <?php
