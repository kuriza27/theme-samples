<?php
/**
 * Template Name: Archive Biographies
...
<div class="d-none display-list-view">
    <section id="<?php echo esc_attr( $id ); ?>-archive-speeches" class="page-header-block pt-140 header archive-speeches">
       <div class="header-content">
            <div class="container">
                        <div class="row">
                            <div class="col">
