<?php
/**
 * Template Name: Archive Protocols and Resources
...
<div class="display-grid-view">
    <section id="<?php echo esc_attr( $id ); ?>-archive-protocols-resources" class="page-header-block pt-140 header archive-programs-resources">
